package hyun.dashboard.publisher.common.aop;
...
import hyun.dashboard.publisher.common.event.SimpleEventPublisher;
import hyun.dashboard.publisher.common.model.entity.Domain;
import hyun.dashboard.publisher.common.module.custom.EventClassFactory;
...
public class EventSourceAspect {
    ...
    @Around("@annotation(hyun.dashboard.publisher.common.annotation.EventPublishPoint)")
